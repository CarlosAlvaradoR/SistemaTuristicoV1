        ...
        <section class="card "> <!-- //- class="box-typical-full-height"-->
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <form action="{{ route('guardar.alimentacion.campo.paquete') }}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="estado" name="idtipoalimentacion" id="idtipoalimentacion" class="form-control">
                                                <option selected>Seleccione...</option>
                                                @foreach ($tiposAlimentacion as $tipo)
