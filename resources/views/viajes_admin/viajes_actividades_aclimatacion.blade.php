        ...
        <header class="section-header">
            <div class="tbl">
                ...
                <ol class="breadcrumb breadcrumb-simple">
                    ...
                    <li class="active">Actividades de Aclimatación</li>
                </ol>
            </div>
        </header>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group has-search">
                                    ...
                                    <input type="text" class="form-control" placeholder="Buscar Actividades de Aclimatación">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a type="button" href="{{ route('paquete.viajes.actividades_aclimatacion.participantes') }}" title="Añadir Participantes"
