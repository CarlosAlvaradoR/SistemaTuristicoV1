...
<head>
    ...
    <title>Reporte de Devoluciones realiados por cancelación de reservas</title>
</head>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"><small>EVENTO DE POSTERGACIÓN</small></th>
                    <th scope="col"><small>MONTO SOLICITADO</small></th>
                    <th scope="col"><small>FECHA Y HORA DE DEVOLUCIÓN</small></th>
                    <th scope="col"><small>MONTO DEVUELTO</small></th>
                </tr>
            </thead>
            @php
                $cont = 1;
            ...
            <tbody>
                @foreach ($consulta as $c)
                    <tr>
                        ...
                        <td><small>{{ date('d/m/Y', strtotime($c->fecha_reserva)) }}</small></td>

                        <td><small>{{ $c->nombre_evento }}</small></td>
                        <td><small>{{ $c->solicitado }}</small></td>
                        <td><small>{{ $c->fecha_hora }}</small></td>
                        <td><small>{{ $c->devuelto }}</small></td>
                    </tr>
                @endforeach
