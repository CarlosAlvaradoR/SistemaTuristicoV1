                ...
                <div class="site-header-shown">
                    <div class="dropdown dropdown-notification notif">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif"
                            ...
                            <div class="dropdown-menu-notif-list">
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{ asset('dashboard_assets/img/photo-64-2.jpg') }}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{ asset('dashboard_assets/img/photo-64-3.jpg') }}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{ asset('dashboard_assets/img/photo-64-4.jpg') }}" alt="">
                                    </div>
                                    ...
                                    <div class="dropdown-menu-messages-list">
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img
                                                    src="dashboard_assets/img/photo-64-2.jpg" alt=""></span>
                                        ...
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img
                                                    src="dashboard_assets/img/avatar-2-64.png" alt=""></span>
                    ...
                    <div class="dropdown user-menu">
                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown"
                            ...
                            <img src="dashboard_assets/img/avatar-2-64.png" alt="">
                        </button>
