                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Ingrese precio en soles peruanos" name="precio" class="form-control" id="precio" />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Ingrese precio en dólares" name="precio" class="form-control" id="precio" />
                                            </div>
                                            <div class="form-group">
