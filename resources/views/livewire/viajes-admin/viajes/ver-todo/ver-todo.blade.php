                                    ...
                                    <td>
                                        <div class="dropdown dropdown-status"><button
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('paquete.viajes.participantes', [$v->slug, $v->id]) }}"><i
                                                ...
                                                <a class="dropdown-item" href="{{ route('paquete.viajes.boletas_pago', [$v->slug, $v->id]) }}"><i
                                                        class="fas fa-money-check"></i> Boletas de Pago del Viaje</a>
                                                <a class="dropdown-item" href="{{ route('paquete.viajes.actividades_aclimatacion', [$v->slug, $v->id]) }}"><i
                                                        class="fas fa-snowboarding"></i> Actividades de Aclimatación</a>
                                                <a class="dropdown-item" href="{{ route('paquete.viajes.hospedaje', [$v->slug, $v->id]) }}"><i
                                                        class="fas fa-hotel"></i> Hospedajes</a>
                                                <a class="dropdown-item" href="{{ route('paquete.viajes.itinerario', [$v->slug, $v->id]) }}"><i
                                                        class="fas fa-clipboard-list"></i> Itinerarios del Viaje</a>
                                                <a class="dropdown-item" href="#!"><i
                                                        class="glyphicon fas fa-users"></i> Arrieros, Cocineros y
                                                    Guías</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="{{ route('paquete.viajes.arriero', [$v->slug, $v->id]) }}">Arrieros</a>
