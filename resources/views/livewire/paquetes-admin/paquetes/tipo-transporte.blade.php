        ...
        <div class="col-lg-12 ks-panels-column-section">
            <div class="card">
                <div class="card-block">
                    <h5 class="card-title">Tipos de Transporte Registrados</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a id="modal-532427" href="#modal-tipo-personal" role="button" class="btn btn-rounded"
                                data-toggle="modal">Nuevo Tipo de Transporte</a>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @else
                        <button type="button" id="save" wire:click="guardarTipoTransporte"
                            wire:loading.attr="disabled" class="btn btn-rounded btn-primary" id="save">
                            Guardar
                        </button>
                    @endif
        ...
        window.addEventListener('swal-confirmTipoPersonal', event => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('paquetes-admin.paquetes.tipo-transporte',
