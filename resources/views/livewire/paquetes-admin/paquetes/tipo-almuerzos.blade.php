        ...
        <div class="col-lg-12 ks-panels-column-section">
            <div class="card">
                <div class="card-block">
                    <h5 class="card-title">Tipos de Almuerzos Registrados</h5>
                        ...
                        <div class="col-md-9">
                            <div class="form-group has-search">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="Buscar Tipo de Almuerzo">
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">TIPO DE ALMUERZO</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @else
                        <button type="button" id="save" wire:click="guardarTipoAlmuerzos"
        ...
        window.addEventListener('swal-confirmTipoPersonal', event => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('paquetes-admin.paquetes.tipo-almuerzos',
                        'deleteTipoAlmuerzo',
                        event.detail
                        .id);
                }
