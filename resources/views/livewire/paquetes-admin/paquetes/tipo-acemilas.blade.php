        ...
        <div class="col-lg-12 ks-panels-column-section">
            <div class="card">
                <div class="card-block">
                    <h5 class="card-title">Tipos de Acémilas Registrados</h5>
                        ...
                        <div class="col-md-9">
                            <div class="form-group has-search">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="Buscar Tipo de Acémila">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <a id="modal-532427" href="#modal-tipo-personal" role="button" class="btn btn-rounded"
                                data-toggle="modal">Nuevo Tipo de Acémilas</a>
                        </div>
                    </div>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">TIPO DE ACÉMILA</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @else
                        <button type="button" id="save" wire:click="guardarTipoAcemilas"
        ...
        window.addEventListener('swal-confirmTipoPersonal', event => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('paquetes-admin.paquetes.tipo-acemilas',
                        'deleteTipoAcemila',
                        event.detail
                        .id);
                }
