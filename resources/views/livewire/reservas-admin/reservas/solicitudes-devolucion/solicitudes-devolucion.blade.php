            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <form>
                        ...
                        <button type="button" wire:click="guardarSolicitud" class="btn btn-primary">Guardar</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="col-lg-6 ks-panels-column-section">
            <div class="card">
                <div class="card-block">
                    ...
                    <button type="button" wire:click="guardarDevolucionDinero" class="btn btn-primary">Guardar</button>
                </div>
            </div>
        </div>
    </div>
