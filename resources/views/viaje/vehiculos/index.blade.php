...
@section('tituloPagina','Vehiculo de las Empresas')
                ...
                <div class="tbl-row">
                    <div class="tbl-cell">
                        ...
                        <ol class="breadcrumb breadcrumb-simple">
                            ...
                            <li class="active">Vehículos - {{$empresaIds}}</li>
                        </ol>
                    </div>
                    <div class="tbl-cell tbl-cell-action button">
                        <a href="{{ route('nueva.vehiculo.empresa.formulario', $empresaIds) }}" class="btn btn-primary">
                            Nuevo
                        </a>
                    </div>
                </div>
                                                ...
                                                <td>
                                                    <div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                                        <div class="btn-group btn-group-sm" style="float: none;">
                                                            ...
                                                            <a href="{{ route('nuevos.choferes.vehiculo', $vehiculo->id) }}" class="tabledit-edit-button btn btn-sm btn-success" style="float: none;" title="Asignar Conductores">
