                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a id="delete" href="{{ route('pedidos.proveedores.cuentasbancarias') }}" title="Añadir Cuentas Bancarias"
                                        class="btn btn-success btn-sm">
                                        <i class="fas fa-plus-circle"></i>
                                    </a>
                                    <a id="view" href="{{ route('pedidos.proveedores.formulario.pedidos') }}" title="Añadir Pedidos a Proveedor"
