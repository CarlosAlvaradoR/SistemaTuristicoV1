...
class Arrieros extends Component
{
    ...
    public function guardarArrieroAlquilerAcemila(){ //Cuado lo encontré como Arriero
        // id del Arriero
        $acemilasAlquiladas = AcemilasAlquiladas::create([
            'monto' => $this->monto,
            'cantidad' => $this->cantidad,
    ...
    public function guardarArrieroYAñadirAcemilasAlquiladas(){ //Cuando lo encontré como Persona, pero no como arriero
