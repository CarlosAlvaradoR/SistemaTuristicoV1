...
Route::post('/paquetes/reserva/save', [App\Http\Controllers\PaquetesTuristicosController::class, 'guardarReserva'])->name('paquetes.reservar.save')->middleware(['auth', 'verified']);
