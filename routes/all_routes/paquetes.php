...
Route::get('/paquetes/tipos-de-paquetes-turisticos', [App\Http\Controllers\PaquetesTuristicosController::class, 'tipoPaquetesTuristicos'])->name('paquetes.tipo_paquetes_turisticos')->middleware(['auth', 'verified']);
