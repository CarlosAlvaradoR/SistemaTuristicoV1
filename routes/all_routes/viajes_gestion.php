...
Route::get('/viajes/reporte/{paquete}/{viaje}/equipos-en préstamo', [App\Http\Controllers\ViajePaquetesController::class, 'mostrarEquiposEnPrestamo'])->name('mostrar.equipos.en prestamo')->middleware(['auth', 'verified']);
